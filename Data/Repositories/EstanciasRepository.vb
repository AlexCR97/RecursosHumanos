...
Public Class EstanciasRepository
    ...
    Implements GenericContract(Of Estancias)
    ...
    Public Function Insert(e As Estancias) As Boolean Implements GenericContract(Of Estancias).Insert
    ...
    Public Function Delete(id As Object) As Boolean Implements GenericContract(Of Estancias).Delete
        parameters = New Dictionary(Of String, Object)
        parameters.Add("@id_usuario", id)
        Return ExecuteQuery(queryDelete)
    End Function

    Public Function Update(e As Estancias) As Boolean Implements GenericContract(Of Estancias).Update
        parameters = New Dictionary(Of String, Object)
        parameters.Add("@id_usuario", e.IdUsuario)
        parameters.Add("@id_institucion", e.IdInstitucion)
        parameters.Add("@nombre_proyecto", e.NombreProyecto)
    ...
    Public Function SelectAll() As List(Of Estancias) Implements GenericContract(Of Estancias).SelectAll
